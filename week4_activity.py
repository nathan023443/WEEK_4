...
# print(result [-3])
# print(result [-5])
# -1 means that substring is not found or dosen't exist
# index slicing is when you get a sub string from a string 
# you can get a subtring when you 
# specify the beginning & end index
# of the substring .  the start index is  inclusice and the end index is exclusive
