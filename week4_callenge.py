...
ttext=" Controlling complexity is the essence of programming"
print( ttext [1:12])
...
my_text2=" Never trust a computer you can't throw out a window"
print(my_text2[9::3])
...
texts = " It's great to work with computers. They dont argue, they rember everything and they dont drink vodka "
